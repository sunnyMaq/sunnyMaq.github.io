...
if(a.indexOf(f)===-1&&n(f,g)){a.push(f)}}document[c]=null;l(d);p(g);return a}},{"@marcom/ac-dom-nodes/isDocumentFragment":15,"@marcom/ac-dom-nodes/isElement":16,"@marcom/ac-dom-nodes/remove":18,"@marcom/ac-polyfills/Array/prototype.indexOf":47}],29:[function(f,i,g){i.exports=function h(a){var b;
return function(){if(typeof b==="undefined"){b=a.apply(this,arguments)}return b
}}},{}],30:[function(d,g,f){g.exports={getWindow:function(){return window},getDocument:function(){return document
},getNavigator:function(){return navigator}}},{}],31:[function(m,l,h){var j=m("./helpers/globals");
...
}l.exports=k(i);l.exports.original=i},{"./helpers/globals":30,"@marcom/ac-function/once":29}],32:[function(m,l,h){var j=m("./helpers/globals");
...
}l.exports=k(i);l.exports.original=i},{"./helpers/globals":30,"@marcom/ac-function/once":29}],33:[function(g,k,h){var i=g("./extend");
