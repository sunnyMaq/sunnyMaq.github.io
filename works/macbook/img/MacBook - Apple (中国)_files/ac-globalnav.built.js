...
}};f.createExpirationDate=c;b.exports=f},{"./Item/apis":7,"./Item/createExpirationDate":10,"./Item/encoder":11,"@marcom/ac-checksum":1,"@marcom/ac-object":131}],7:[function(d,g,b){var h=d("@marcom/ac-console").log;
...
return true}});return i}};g.exports=f},{"./apis/localStorage":8,"./apis/userData":9,"@marcom/ac-console":3}],8:[function(d,f,b){var a=d("@marcom/ac-feature");
...
return true}};f.exports=c},{"@marcom/ac-feature":100}],9:[function(d,f,c){var g=d("@marcom/ac-dom-nodes");
...
},setOptions:function(j){this._namespace=j}};h.exports=i},{"./Item/apis/localStorage":8,"./Storage/registry":14,"@marcom/ac-object":131}],14:[function(f,g,c){var d=f("../Item");
...
}return j})}())},{}],17:[function(f,d,h){f("@marcom/ac-polyfills/Promise");f("@marcom/ac-polyfills/Object/create");
var i=null;try{i=f("@marcom/ac-storage")}catch(k){}var p=f("@marcom/ac-event-emitter-micro").EventEmitterMicro;
...
q[q.length-1]["last"]=true}return q||[]};var g=function(I,J,Q,A){p.call(this);var D=this;
var B=null;var C=null;var q=null;var w=null;var F=false;var N={storeState:{bag:null,segmentNav:null,covers:null},itemCount:-1,storefront:{}};
var G=function G(T,U){var R;var S=N[T];var V=S!==U;if(V&&typeof S==="object"&&U==="object"){V=false;
for(R in U){V=V||U[R]!==S[R]}for(R in S){V=V||!(R in U)}}if(V){N[T]=U;D.trigger(T+"Change",U)
}};var z=function z(T,V,R){var S=(T.indexOf("?")===-1?"?":"&");var U=/(%5B|\[)storefront(%5D|\])/g;
T=T.replace(U,V.storefront||J);T=T.indexOf("//")===0?window.location.protocol+T:T;
T+=S+"apikey="+encodeURIComponent(Q);T+=R?"&l="+encodeURIComponent(window.location+""):"";
return new Promise(function(Y,X){try{var W=new XMLHttpRequest();W.onreadystatechange=function aa(){if(W.readyState===4){try{var ac=JSON.parse(W.responseText);
Y(ac)}catch(ab){X()}}else{if(W.readyState===4){X()}}};W.open("GET",T);W.withCredentials=true;
W.send()}catch(Z){X()}})};var u=function(){var S=(window.decodeURIComponent(window.escape(j.atob(a.getAs("sfa")||"")))||"").split("|");
var R=function R(T){return S[0]==="2"&&T===9?S[2]:S[0]==="2"&&T>1?S[T+1]:S[T]};
C=C||{version:R(0),storefront:R(1),name:R(2),locale:R(3),segmentCode:R(4),channelCode:R(5),showBanner:R(6)==="1"||R(6)==="true",persistBanner:R(7)==="1"||R(7)==="true",bagEnabled:R(8)!=="0"&&R(8)!=="false",consumerStorefront:R(9)};
return C};var M=function M(){return new Promise(function(S,R){var T=u();G("storefront",T);
S(T)})};var y=function y(){var U=(new Date()).getTime();var T=false;var S=true;
var V=true;var R=null;w=w||(M().then(function(aa){var ab=a.getAs("cn");var Y=aa.storefront||J;
var W=/([^\/]*)\/\/([^\/]*)\/.*/;var X=(document.referrer||"").replace(W,"$2");
var Z=(document.location+"").replace(W,"$2");B=B||c.getItem(l);S=aa.bagEnabled;
V=aa.showBanner;T=B&&((F&&B.ttl===0)||(U<B.ttl&&ab===B.cn&&Q===B.key&&Y===B.sfLoc&&(!X||X===Z)));
return T||!S?Promise.resolve():z(A,aa,false).then(function(ac){R=isNaN(parseInt(ac.items,10));
B={ttl:(parseInt(ac.ttl,10)*1000+U)||0,items:!R?parseInt(ac.items,10):0,cn:ab,api:ac.api,key:Q,sfLoc:Y};
c.setItem(l,B);F=!!ac.api&&!ac.disabled})}).then(function(){},function(){}).then(function(){return new Promise(function(Y,X){var W=S&&(T||F);
G("storeState",{bag:W,segmentNav:V,covers:R});G("itemCount",(B&&B.items)||0);w=null;
if(W){Y()}else{X()}})}));return w};var t=function t(R){a.removeAs("sfa","/",".apple.com");
c.removeItem(l);B=null;C=null;u();if(!R){y()}};var s=u();var v=s.consumerStorefront;
if(!!v&&!!J&&v!==J){t(true)}this.getStoreState=function P(){return y().then(function(){return N.storeState
})};this.getItemCount=function r(){return y().then(function(){return N.itemCount
})};this.__setItemCount=function E(R){q=null;G("itemCount",R);if(B){B.items=R;c.setItem(l,B)
}};this.getStorefront=M;this.exitStorefront=t;this.addItem=function K(R){return new Promise(function(T,S){this.trigger("itemAdded");
T()})};this.addFavorite=function L(R){return new Promise(function(T,S){this.trigger("favoriteAdded");
T()})};this.updateBagFlyout=function x(){if(q===null){I.innerHTML=n.render(o.items,{loading:{text:"Loading..."}});
q=true;(B&&B.api?Promise.resolve():y()).then(M).then(function(U){var T=B&&B.api&&B.api.flyout;
if(!T){throw"No Flyout API URL"}return z(T,U,true)}).then(function S(U){q=U||{};
...
}if(q.promoLinks.length>0){q.explodedPromoLinks={promoLinks:q.promoLinks}}for(var T=0;
T<q.bag["items"].length;T+=1){var V=q.bag["items"][T]||{};V.qty=V.qty>1?{text:V.qty}:false
}I.innerHTML=n.render(o.items,q)},function R(){q=null})}};this.clearCache=function O(R){if(!R||!F){c.removeItem(l);
B=null;C=null;y()}};this.clearBagCache=function H(){q=null}};g.prototype=Object.create(p.prototype);
g.staticClearCache=function b(){c.removeItem(l)};d.exports=g},{"../mustache/items.mustache":19,"./cookie.js":18,"@marcom/ac-event-emitter-micro":82,"@marcom/ac-polyfills/Object/create":161,"@marcom/ac-polyfills/Promise":163,"@marcom/ac-storage":5,Base64:16,mustache:192}],18:[function(f,g,c){var b=function b(k){var j=encodeURIComponent(k).replace(/[\-\.\+\*]/g,"\\$&");
...
};c.exports=f},{"./data":23,"@marcom/ac-polyfills/Array/prototype.filter":152,"@marcom/ac-polyfills/Array/prototype.some":156}],22:[function(b,c,a){c.exports={getDocumentMode:function(){var d;
...
return}for(g=0;g<j.length;g++){d(h,j[g])}}},{"./className/add":26,"@marcom/ac-polyfills/Array/prototype.slice":155,"@marcom/ac-polyfills/Element/prototype.classList":158}],25:[function(b,c,a){c.exports={add:b("./className/add"),contains:b("./className/contains"),remove:b("./className/remove")}
...
}return f(h,g)}},{"./className/contains":27,"@marcom/ac-polyfills/Element/prototype.classList":158}],31:[function(b,c,a){c.exports={add:b("./add"),contains:b("./contains"),remove:b("./remove"),toggle:b("./toggle")}
...
return}for(g=0;g<j.length;g++){b(h,j[g])}}},{"./className/remove":29,"@marcom/ac-polyfills/Array/prototype.slice":155,"@marcom/ac-polyfills/Element/prototype.classList":158}],33:[function(c,d,b){c("@marcom/ac-polyfills/Element/prototype.classList");
...
}},{"./className":25,"@marcom/ac-polyfills/Element/prototype.classList":158}],34:[function(c,d,b){var g=c("./utils/addEventListener");
...
return i.filter(function(j){return g(j,h)})}},{"./ELEMENT_NODE":50,"./internal/isNodeType":61,"@marcom/ac-polyfills/Array/prototype.filter":152,"@marcom/ac-polyfills/Array/prototype.slice":155}],54:[function(c,d,a){d.exports=function b(g,f){if("hasAttribute" in g){return g.hasAttribute(f)
...
}return j.indexOf(k)}},{"./filterByNodeType":53,"./internal/validate":62,"@marcom/ac-polyfills/Array/prototype.indexOf":154,"@marcom/ac-polyfills/Array/prototype.slice":155}],57:[function(b,c,a){var f=b("./internal/validate");
...
}}}},{"@marcom/ac-dom-nodes/COMMENT_NODE":46,"@marcom/ac-dom-nodes/DOCUMENT_FRAGMENT_NODE":47,"@marcom/ac-dom-nodes/DOCUMENT_NODE":48,"@marcom/ac-dom-nodes/ELEMENT_NODE":50,"@marcom/ac-dom-nodes/TEXT_NODE":51,"@marcom/ac-dom-nodes/isNode":68,"@marcom/ac-polyfills/Array/prototype.indexOf":154}],76:[function(d,f,c){var g=d("@marcom/ac-dom-nodes/isElement");
...
}},{"./internal/validate":75,"./shims/querySelectorAll":81,"@marcom/ac-polyfills/Array/prototype.slice":155}],79:[function(c,d,b){var f=c("../querySelectorAll");
...
if(m.indexOf(o)===-1&&i(o,n)){m.push(o)}}document[q]=null;k(p);g(n);return m}},{"@marcom/ac-dom-nodes/isDocumentFragment":65,"@marcom/ac-dom-nodes/isElement":67,"@marcom/ac-dom-nodes/remove":71,"@marcom/ac-polyfills/Array/prototype.indexOf":154}],82:[function(b,c,a){c.exports={EventEmitterMicro:b("./ac-event-emitter-micro/EventEmitterMicro")}
...
h.os=g.__getOS(d.os);h.osVersion=g.__getOSVersion(d.versionString,h.os);return h
};c.exports=f},{"./data":87,"@marcom/ac-polyfills/Array/prototype.filter":152,"@marcom/ac-polyfills/Array/prototype.some":156}],86:[function(b,c,a){c.exports={getDocumentMode:function(){var d;
if(document.documentMode){d=parseInt(document.documentMode,10)}else{d=5;if(document.compatMode){if(document.compatMode==="CSS1Compat"){d=7
...
},{"./helpers/globals":109,"@marcom/ac-function/once":124,"@marcom/ac-polyfills/matchMedia":165}],117:[function(c,d,b){var g=c("./helpers/globals");
...
}return f}}},{}],125:[function(b,d,a){var g=b("@marcom/ac-classlist/add");var h=b("@marcom/ac-classlist/remove");
...
}}};d.exports=c},{"@marcom/ac-classlist/add":24,"@marcom/ac-classlist/remove":32,"@marcom/ac-object/extend":135}],126:[function(d,f,c){var a=d("qs");
f.exports=function b(h,g){var i=a.stringify(h,{strictNullHandling:true});if(i&&g!==false){i="?"+i
}return i}},{qs:127}],127:[function(b,d,a){var g=b("./stringify");var c=b("./parse");
var f={};d.exports={stringify:g,parse:c}},{"./parse":128,"./stringify":129}],128:[function(b,c,a){var f=b("./utils");
...
h=f.merge(h,g,p)}return f.compact(h)}},{"./utils":130}],129:[function(b,c,a){var f=b("./utils");
...
}return r.join(j)}},{"./utils":130}],130:[function(b,c,a){var f={};f.hexTable=new Array(256);
...
}},{}],131:[function(b,c,a){c.exports={clone:b("./clone"),create:b("./create"),defaults:b("./defaults"),extend:b("./extend"),getPrototypeOf:b("./getPrototypeOf"),isDate:b("./isDate"),isEmpty:b("./isEmpty"),isRegExp:b("./isRegExp"),toQueryParameters:b("./toQueryParameters")}
},{"./clone":132,"./create":133,"./defaults":134,"./extend":135,"./getPrototypeOf":136,"./isDate":137,"./isEmpty":138,"./isRegExp":139,"./toQueryParameters":140}],132:[function(c,d,b){c("@marcom/ac-polyfills/Array/isArray");
...
}return h({},j)}},{"./extend":135,"@marcom/ac-polyfills/Array/isArray":151}],133:[function(b,d,a){var f=function(){};
...
return new f()}}},{}],134:[function(b,c,a){var f=b("./extend");c.exports=function d(h,g){if(typeof h!=="object"){throw new TypeError("defaults: must provide a defaults object")
}g=g||{};if(typeof g!=="object"){throw new TypeError("defaults: options must be a typeof object")
}return f({},h,g)}},{"./extend":135}],135:[function(c,d,b){c("@marcom/ac-polyfills/Array/prototype.forEach");
var a=Object.prototype.hasOwnProperty;d.exports=function f(){var h;var g;if(arguments.length<2){h=[{},arguments[0]]
}else{h=[].slice.call(arguments)}g=h.shift();h.forEach(function(j){if(j!=null){for(var i in j){if(a.call(j,i)){g[i]=j[i]
}}}});return g}},{"@marcom/ac-polyfills/Array/prototype.forEach":153}],136:[function(c,d,b){var a=Object.prototype.hasOwnProperty;
...
i.constructor=h}return g?g.prototype:null}}}}},{}],137:[function(b,d,a){d.exports=function c(f){return Object.prototype.toString.call(f)==="[object Date]"
}},{}],138:[function(c,d,b){var a=Object.prototype.hasOwnProperty;d.exports=function f(g){var h;
if(typeof g!=="object"){throw new TypeError("ac-base.Object.isEmpty : Invalid parameter - expected object")
}for(h in g){if(a.call(g,h)){return false}}return true}},{}],139:[function(c,d,b){d.exports=function a(f){return window.RegExp?f instanceof RegExp:false
}},{}],140:[function(c,f,b){var a=c("@marcom/ac-url/joinSearchParams");f.exports=function d(g){if(typeof g!=="object"){throw new TypeError("toQueryParameters error: argument is not an object")
}return a(g,false)}},{"@marcom/ac-url/joinSearchParams":126}],141:[function(b,c,a){var d=b("./promise/promise").Promise;
var f=b("./promise/polyfill").polyfill;a.Promise=d;a.polyfill=f},{"./promise/polyfill":145,"./promise/promise":146}],142:[function(c,d,b){var a=c("./utils").isArray;
...
}else{j(k,q)}}})}b.all=f},{"./utils":150}],143:[function(b,c,a){(function(f,g){var o=(typeof window!=="undefined")?window:{};
...
},{_process:179}],144:[function(d,f,a){var c={instrument:false};function b(g,h){if(arguments.length===2){c[g]=h
}else{return c[g]}}a.config=c;a.configure=b},{}],145:[function(b,c,a){(function(f){var d=b("./promise").Promise;
...
},{"./promise":146,"./utils":150}],146:[function(q,d,D){var B=q("./config").config;
...
}D.Promise=h},{"./all":142,"./asap":143,"./config":144,"./race":147,"./reject":148,"./resolve":149,"./utils":150}],147:[function(c,f,b){var a=c("./utils").isArray;
...
}else{m(n)}}})}b.race=d},{"./utils":150}],148:[function(b,c,a){function d(g){var f=this;
return new f(function(i,h){h(g)})}a.reject=d},{}],149:[function(b,c,a){function d(g){if(g&&typeof g==="object"&&g.constructor===this){return g
}var f=this;return new f(function(h){h(g)})}a.resolve=d},{}],150:[function(d,f,b){function g(i){return h(i)||(typeof i==="object"&&i!==null)
...
b.isArray=a;b.now=c},{}],151:[function(b,c,a){if(!Array.isArray){Array.isArray=function(d){return Object.prototype.toString.call(d)==="[object Array]"
}}},{}],152:[function(b,c,a){if(!Array.prototype.filter){Array.prototype.filter=function d(l,k){var j=Object(this);
var f=j.length>>>0;var h;var g=[];if(typeof l!=="function"){throw new TypeError(l+" is not a function")
}for(h=0;h<f;h+=1){if(h in j&&l.call(k,j[h],h,j)){g.push(j[h])}}return g}}},{}],153:[function(b,c,a){if(!Array.prototype.forEach){Array.prototype.forEach=function d(k,j){var h=Object(this);
var f;var g;if(typeof k!=="function"){throw new TypeError("No function object passed to forEach.")
}for(f=0;f<this.length;f+=1){g=h[f];k.call(j,g,f,h)}}}},{}],154:[function(b,c,a){if(!Array.prototype.indexOf){Array.prototype.indexOf=function d(g,h){var i=h||0;
var f=0;if(i<0){i=this.length+h-1;if(i<0){throw"Wrapped past beginning of array while looking up a negative start index."
}}for(f=0;f<this.length;f++){if(this[f]===g){return f}}return(-1)}}},{}],155:[function(b,c,a){(function(){var d=Array.prototype.slice;
try{d.call(document.documentElement)}catch(f){Array.prototype.slice=function(n,j){j=(typeof j!=="undefined")?j:this.length;
if(Object.prototype.toString.call(this)==="[object Array]"){return d.call(this,n,j)
}var l,h=[],k,g=this.length;var o=n||0;o=(o>=0)?o:g+o;var m=(j)?j:g;if(j<0){m=g+j
}k=m-o;if(k>0){h=new Array(k);if(this.charAt){for(l=0;l<k;l++){h[l]=this.charAt(o+l)
}}else{for(l=0;l<k;l++){h[l]=this[o+l]}}}return h}}}())},{}],156:[function(b,c,a){if(!Array.prototype.some){Array.prototype.some=function d(k,j){var g=Object(this);
...
}}},{}],157:[function(c,d,a){if(!Date.now){Date.now=function b(){return new Date().getTime()
}}},{}],158:[function(b,c,a){
...
}else{return d.call(this,h)}}}f=null}())}}},{}],159:[function(b,c,a){if(!Function.prototype.bind){Function.prototype.bind=function(d){if(typeof this!=="function"){throw new TypeError("Function.prototype.bind - what is trying to be bound is not callable")
...
};f.prototype=this.prototype;g.prototype=new f();return g}}},{}],160:[function(require,module,exports){if(typeof JSON!=="object"){JSON={}
...
}}}())},{}],161:[function(b,c,a){if(!Object.create){var d=function(){};Object.create=function(f){if(arguments.length>1){throw new Error("Second argument not supported")
}if(f===null||typeof f!=="object"){throw new TypeError("Object prototype may only be an Object.")
}d.prototype=f;return new d()}}},{}],162:[function(b,c,a){if(!Object.keys){Object.keys=function d(g){var f=[];
var h;if((!g)||(typeof g.hasOwnProperty!=="function")){throw"Object.keys called on non-object."
}for(h in g){if(g.hasOwnProperty(h)){f.push(h)}}return f}}},{}],163:[function(b,c,a){c.exports=b("es6-promise").polyfill()
},{"es6-promise":141}],164:[function(c,d,b){if(!String.prototype.trim){String.prototype.trim=function a(){return this.replace(/^\s+|\s+$/g,"")
}}},{}],165:[function(b,c,a){window.matchMedia=window.matchMedia||(function(i,j){var g,d=i.documentElement,f=d.firstElementChild||d.firstChild,h=i.createElement("body"),k=i.createElement("div");
...
}}(document))},{}],166:[function(b,c,a){(function(){var f=0;var g=["ms","moz","webkit","o"];
...
}}}())},{}],167:[function(b,d,a){d.exports=function c(f){return(f.charAt(0).toUpperCase()+f.slice(1))
}},{}],168:[function(b,c,a){var f="[A-Z\\xc0-\\xd6\\xd8-\\xde]";var g="[a-z\\xdf-\\xf6\\xf8-\\xff]";
var d=new RegExp("("+f+"+"+g+"*|"+f+"*"+g+"+|[0-9]+)","g");c.exports=function h(i){return i.match(d)||[]
}},{}],169:[function(b,d,a){var i=b("./splitWords");var g=b("./utils/transformWords");
var c=b("./capitalize");var f=function(k,l,j){if(l){return k.toLowerCase()}return c(k.toLowerCase())
};d.exports=function h(j){return g(j,f)}},{"./capitalize":167,"./splitWords":168,"./utils/transformWords":170}],170:[function(b,c,a){var f=b("../splitWords");
c.exports=function d(l,m){var k=f(l);var j=k.length;var g="";var h;for(h=0;h<j;
h++){g+=m(k[h],h===0,h===j-1)}return g}},{"../splitWords":168}],171:[function(b,a,f){b("@marcom/ac-polyfills/Function/prototype.bind");
...
document.documentElement.clientWidth};a.exports=k},{"@marcom/ac-dom-events/utils/addEventListener":44,"@marcom/ac-event-emitter-micro":82,"@marcom/ac-feature/mediaQueriesAvailable":116,"@marcom/ac-polyfills/Function/prototype.bind":159,"@marcom/ac-polyfills/Object/create":161,"@marcom/ac-polyfills/Object/keys":162}],172:[function(i,c,x){var s=Object.prototype.toString;
...
}catch(z){return A}}},{}],173:[function(c,f,b){var a=c("qs");f.exports=function d(g){if(typeof g!=="object"){throw new TypeError("toQueryParameters error: argument is not an object")
}return a.stringify(g)}},{qs:172}],174:[function(b,f,a){var g=b("./request/factory");
...
return c.ajax(i,j)}};f.exports=c},{"./request/factory":175}],175:[function(c,b,f){var j=c("./xmlhttprequest");
...
};b.exports=function(k,l){var m=d&&g(k)?i:j;return new m()}},{"./xdomainrequest":177,"./xmlhttprequest":178}],176:[function(b,d,a){var c=function(){};
...
}};d.exports=c},{}],177:[function(b,f,a){var d=b("./request");var c=b("ac-object/toQueryParameters");
...
}this.xhr.send(h)};g.prototype.setTransportHeaders=function(h){};f.exports=g},{"./request":176,"ac-object/toQueryParameters":173}],178:[function(b,d,a){var c=b("./request");
...
};d.exports=f},{"./request":176}],179:[function(c,d,b){var h=d.exports={};var a=[];
...
};h.umask=function(){return 0}},{}],180:[function(b,c,a){arguments[4][82][0].apply(a,arguments)
...
}};q.prototype.rawValue=function l(W){return W[1]};L.name="https://www.apple.com/ac/globalnav/2.0/zh_CN/scripts/mustache.js";L.version="2.2.1";
...
var d=new f()},{"./ac-globalnav/GlobalNav":194,"@marcom/ac-polyfills/Array/isArray":151,"@marcom/ac-polyfills/Array/prototype.forEach":153,"@marcom/ac-polyfills/Array/prototype.indexOf":154,"@marcom/ac-polyfills/Array/prototype.some":156,"@marcom/ac-polyfills/Function/prototype.bind":159,"@marcom/ac-polyfills/Object/create":161,"@marcom/ac-polyfills/String/prototype.trim":164,"@marcom/ac-polyfills/requestAnimationFrame":166}],194:[function(m,d,D){var u=m("@aos/ac-store");
...
};b.exports=h},{"@marcom/ac-dom-events/target":43,"@marcom/ac-dom-events/utils/addEventListener":44,"@marcom/ac-dom-traversal/ancestors":73,"@marcom/ac-event-emitter-micro":82,"@marcom/ac-polyfills/Function/prototype.bind":159}],196:[function(d,f,c){var g=d("@marcom/ac-browser");
...
};c.exports=a},{"./sectionAnalyticsEvents":208,"./sectionLabels":209,"@marcom/ac-polyfills/Date/now":157,"@marcom/ac-polyfills/JSON":160,"ac-ajax-xhr":174,"ac-mvc-model":190}],206:[function(d,c,g){var f=d("@marcom/ac-classlist");
...
};c.exports=m},{"../../helpers/keyMap":198,"@marcom/ac-classlist":31,"@marcom/ac-dom-events/target":43,"@marcom/ac-dom-events/utils/addEventListener":44,"@marcom/ac-dom-traversal/querySelectorAll":78,"@marcom/ac-event-emitter-micro":82,"@marcom/ac-object/clone":132}],207:[function(b,a,d){var h=b("mustache");
